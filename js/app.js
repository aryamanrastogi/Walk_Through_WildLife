...
function start() {
  ...
  searchForm.onsubmit = function (event) {
    ...
    // To get the value from the search form input and pass it to the
    // search() function (defined in js/search.js)    
    //search() function call with value from search form
    search(searchForm.searchBox.value);
  };
