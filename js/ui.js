...
function toggleLoading(isLoading) {
  // To toggle the state of the Search button. When we click 'Search' we need to
  ...
  //to disable the button, and change the inner content of the button while the search is in progress
  if (isLoading) {
  ...
  //to re-enable the button, and change the inner content of the button back to default
  else {
    const searchButton = document.querySelector("#searchButton");
    searchButton.innerHTML = '<i class="fa fa-search"></i>&nbsp;Search';
